...
if ( ! function_exists( 'wpazure_kit_consultera_service' ) ) :
	function wpazure_kit_consultera_service() {
		...
		$HomeServiceSectionLayout = get_theme_mod('service_section_layout_2',false);
	...
	if($HomeServiceEnabled==true){ ?>
		<section class="section-padding-100 services-section bg-offwhite">
			...
			<?php }?>
				...
				<?php if ($HomeServiceSectionLayout == true){

					?>
					
					<div class="col-md-4 col-12 mb-md-0 mb-2">
						<div class="featured-services-child">
							<div class="media">
							<?php if(!empty($HomeServiceOneIcon)){?>
							  	<div class="d-flex justify-content-center"><i class="fa <?php echo $HomeServiceOneIcon;?>" aria-hidden="true"></i></div>
								<?php } ?>

							  	<div class="media-body">
								 <?php  if(!empty($HomeServiceOneTitle)){ ?>
							    	<h3><?php echo $HomeServiceOneTitle; ?> </h3>
									<?php } if(!empty($HomeServiceOneDesc)){ ?>
							    	<p>
										<?php echo $HomeServiceOneDesc ;?>
									</p>
									<?php }  if(!empty($HomeServiceOneButtonText)){?>
									<a href="<?php echo esc_attr($HomeServiceOneButtonLink); ?>" <?php  if($HomeServiceOneButtonTarget == true){echo "target='_blank'";}?> class="read-more-child">
										<?php echo $HomeServiceOneButtonText;?>
									</a>
									<?php }?>
							  	</div>
							</div>
					...
					<div class="col-md-4 col-12 mb-md-0 mb-2">
						<div class="featured-services-child">
							...
							<?php if(!empty($HomeServiceTwoIcon)){?>
							  	<div class="d-flex justify-content-center"><i class="fa <?php echo $HomeServiceTwoIcon;?>" aria-hidden="true"></i></div>
								<?php } ?>

							  	<div class="media-body">
								 <?php  if(!empty($HomeServiceTwoTitle)){ ?>
							    	<h3><?php echo $HomeServiceTwoTitle; ?> </h3>
									<?php } if(!empty($HomeServiceTwoDesc)){ ?>
							    	<p>
										<?php echo $HomeServiceTwoDesc ;?>
									</p>
									<?php }  if(!empty($HomeServiceTwoButtonText)){?>
									<a href="<?php echo esc_attr($HomeServiceTwoButtonLink); ?>" <?php  if($HomeServiceTwoButtonTarget == true){echo "target='_blank'";}?> class="read-more-child">
										<?php echo $HomeServiceTwoButtonText;?>
									</a>
									<?php }?>
							  	</div>
							</div>
					...
					<div class="col-md-4 col-12 mb-md-0 mb-2">
						<div class="featured-services-child">
							...
							<?php if(!empty($HomeServiceThreeIcon)){?>
							  	<div class="d-flex justify-content-center"><i class="fa <?php echo $HomeServiceThreeIcon;?>" aria-hidden="true"></i></div>
								<?php } ?>

							  	<div class="media-body">
								 <?php  if(!empty($HomeServiceThreeTitle)){ ?>
							    	<h3><?php echo $HomeServiceThreeTitle; ?> </h3>
									<?php } if(!empty($HomeServiceThreeDesc)){ ?>
							    	<p>
										<?php echo $HomeServiceThreeDesc ;?>
									</p>
									<?php }  if(!empty($HomeServiceThreeButtonText)){?>
									<a href="<?php echo esc_attr($HomeServiceThreeButtonLink); ?>" <?php  if($HomeServiceThreeButtonTarget == true){echo "target='_blank'";}?> class="read-more-child">
										<?php echo $HomeServiceThreeButtonText;?>
									</a>
									<?php }?>
							  	</div>
							</div>
